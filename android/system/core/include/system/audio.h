...
typedef enum {
    ...
    AUDIO_FORMAT_RAW_AC3             = 0x08000000UL,
    AUDIO_FORMAT_RAW_DTS             = 0x09000000UL,
    AUDIO_FORMAT_PCM_24BIT			 = 0x10000000UL,
    AUDIO_FORMAT_PCM_DIR_16_BIT		 = 0x11000000UL,
...
static inline bool audio_is_valid_format(audio_format_t format)
{
    ...
    case AUDIO_FORMAT_RAW_AC3:
    case AUDIO_FORMAT_RAW_DTS:
    case AUDIO_FORMAT_PCM_24BIT:
    case AUDIO_FORMAT_PCM_DIR_16_BIT:
        return true;
    default:
        return false;
    }
...
{
    return (((format & AUDIO_FORMAT_MAIN_MASK) == AUDIO_FORMAT_PCM)||((format & AUDIO_FORMAT_MAIN_MASK) == AUDIO_FORMAT_PCM_DIR_16_BIT)||((format & AUDIO_FORMAT_MAIN_MASK) == AUDIO_FORMAT_PCM_24BIT)||((format & AUDIO_FORMAT_MAIN_MASK) == AUDIO_FORMAT_RAW_AC3)||((format & AUDIO_FORMAT_MAIN_MASK) == AUDIO_FORMAT_RAW_DTS));
}
