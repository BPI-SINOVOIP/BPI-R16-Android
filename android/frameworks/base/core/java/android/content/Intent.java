...
public class Intent implements Parcelable, Cloneable {
   ...
   /**
	...
	/**
     * Broadcast Action: Wired Linein plugged in or unplugged.
     *
     * <p>The intent will have the following extra values:
     * <ul>
     *   <li><em>state</em> - false for unplugged, true for plugged. </li>
     * </ul>
     * </ul>
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_LINEIN_PLUG =
            "android.intent.action.LINEIN_PLUG";
