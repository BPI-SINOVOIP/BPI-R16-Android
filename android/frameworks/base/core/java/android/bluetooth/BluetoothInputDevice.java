...
public final class BluetoothInputDevice implements BluetoothProfile {
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_GET_REPORT_RESULT =
        "android.bluetooth.input.profile.action.GET_REPORT_RESULT";

    /**
     * @hide
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_SET_REPORT_STATUS =
        "android.bluetooth.input.profile.action.SET_REPORT_STATUS";
    ...
    /**
     * The status for set_report result.
     * @hide
     */
