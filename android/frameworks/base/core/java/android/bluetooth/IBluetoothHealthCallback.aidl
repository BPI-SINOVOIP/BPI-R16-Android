...
interface IBluetoothHealthCallback
{
    ...
    void onHealthDeviceSourceDataTypeResult(in BluetoothHealthAppConfiguration config,
        in BluetoothDevice device, in int[] dataTypes);
    void onHealthDeviceSinkDataTypeResult(in BluetoothHealthAppConfiguration config,
        in BluetoothDevice device, in int[] dataTypes);
}
