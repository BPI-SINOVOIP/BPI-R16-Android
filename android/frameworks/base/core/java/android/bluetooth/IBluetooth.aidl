...
interface IBluetooth
{
    ...
    boolean registerRadioClient (in IBluetoothManagerCallback callback ,
                                               in ParcelUuid uuid, in int radioType);
    boolean unregisterRadioClient(in ParcelUuid uuid);
    ...
    boolean sspDebugConfigure(in boolean enable);
    ...
    //Wake lock for bt stack native code
    void initWakeLock(in ParcelFileDescriptor lock, in ParcelFileDescriptor unlock);
