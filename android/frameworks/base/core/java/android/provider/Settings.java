...
public final class Settings {
	...
	public static final String MIRACAST_FULL_SCREEN = "miracast_full_screen";

	public static final String MIRACAST_CONTROL = "miracast_control";

	/**
         * air plane mode already set
         * @hide
         */

        public static final String AIRPLANE_MODE_SET = "airplane_mode_set";
        /**
	...
	public static final String ROTATION_MODE_SET = "rotation_mode_set";
    /* highlight */
    public static final String SCREENRECORD_VIDEO_SIZE = "screenrecord_video_size";
    public static final String SCREENRECORD_VIDEO_TIME_LIMIT = "screenrecord_video_time_limit";
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
        ...
        /** {@hide} */
        public static final String
                BLUETOOTH_HFDEVICE_PRIORITY_PREFIX = "bluetooth_hfdevice_priority_";
        ...
        /**
         * Get the key that retrieves a bluetooth HFP-HF priority.
         * @hide
         */
        public static final String getBluetoothHfDevicePriorityKey(String address) {
            return BLUETOOTH_HFDEVICE_PRIORITY_PREFIX + address.toUpperCase();
        }
