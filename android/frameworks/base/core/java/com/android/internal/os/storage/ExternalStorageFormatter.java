...
public class ExternalStorageFormatter extends Service
    ...
    void updateProgressState() {
        ...
        final String extTempPath = mStorageVolume == null ?
                Environment.getLegacyExternalStorageDirectory().toString() :
                mStorageVolume.getPath();
        final boolean isUsb = extTempPath.contains("usb");
        if (Environment.MEDIA_MOUNTED.equals(status)
			...
			if (isUsb){
				fail(R.string.custom_usb_media_checking);
			}else{
				fail(R.string.custom_sd_media_checking);
			}
    ...
    private void StartRecoverThread(){
