...
static int movie_gifFrameDuration(JNIEnv* env, jobject movie, int frameIndex) {
    ...
    //ALOGE("Movie:movie_gifFrameDuration: frame number %d, duration is %d", frameIndex,m->getGifFrameDuration(frameIndex));
...
static int movie_gifTotalFrameCount(JNIEnv* env, jobject movie) {
    ...
    //ALOGE("Movie:movie_gifTotalFrameCount: frame count %d", m->getGifTotalFrameCount());
...
static JNINativeMethod gMethods[] = {
    ...
    {   "closeGif",   "()V",
                            (void*)movie_closeGif  },
    { "nativeDecodeMarkedStream", "(Ljava/io/InputStream;)Landroid/graphics/Movie;",
