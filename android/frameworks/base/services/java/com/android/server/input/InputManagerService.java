...
public class InputManagerService extends IInputManager.Stub
	...
	/** Switch code: Linein Jack.  When set, something is plug out. */
    public static final int SW_LINEIN_PLUGOUT = 0x0c;

	/** Switch code: Linein Jack.  When set, something is inserted. */
    public static final int SW_LINEIN_INSERT = 0x0d;
	...
	public static final int SW_LINEIN_PLUGOUT_BIT = 1 << SW_LINEIN_PLUGOUT;
	public static final int SW_LINEIN_INSERT_BIT = 1 << SW_LINEIN_INSERT;
	public static final int SW_LINEIN_BITS = SW_LINEIN_PLUGOUT_BIT | SW_LINEIN_INSERT_BIT;
    ...
    private void notifySwitch(long whenNanos, int switchValues, int switchMask) {
		...
		if ((switchMask & SW_LINEIN_BITS) != 0) {
            final int lineinInsert = (switchValues & SW_LINEIN_INSERT_BIT) > 0 ? 1 : 0;
            mWindowManagerCallbacks.notifyLineinSwitchChanged(whenNanos, lineinInsert);
        }
