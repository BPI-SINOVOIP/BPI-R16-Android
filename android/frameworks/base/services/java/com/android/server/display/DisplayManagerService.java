...
public final class DisplayManagerService extends IDisplayManager.Stub {
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
			...
			try{
			       ...
			       setDisplayEnhanceMode((brightSystemMode&0x01)>0?1:0);
			       setDisplayEnhanceDemoMode((brightSystemMode&0x02)>0?1:0);
			       setDisplayBacklightMode((brightnessLightMode&0x01)>0?1:0);
			       setDisplayBacklightDemoMode((brightnessLightMode&0x02)>0?1:0);
			}
			catch(SettingNotFoundException e){
			       Slog.e(TAG, Settings.System.BRIGHTNESS_LIGHT_MODE +" or" +
	    ...
	    resolver.registerContentObserver(Settings.System.getUriFor(
		    Settings.System.MIRACAST_FULL_SCREEN), false, this);
	    resolver.registerContentObserver(Settings.System.getUriFor(
		    Settings.System.MIRACAST_CONTROL), false, this);
            update();
        }
		...
		boolean isFullScreen = (Settings.System.getInt(resolver,
					  Settings.System.MIRACAST_FULL_SCREEN) & 0x01) > 0;
		int miracast_value = (Settings.System.getInt(resolver,
                                          Settings.System.MIRACAST_CONTROL));
		...
		if (mMiracast_value != miracast_value){
			Slog.v(TAG,"update:miracast_value=" + miracast_value);
			mMiracast_value = miracast_value;
			synchronized (mSyncRoot) {
				 scheduleTraversalLocked(false);
			}	
		}
    ...
    private void notifyBoostUPerf() {
        ...
        if (IsystemReady) {
            ...
            DynamicPManager.getInstance().notifyDPM(intent);
        }
    }
    ...
    private void addLogicalDisplayLocked(DisplayDevice device) {
        ...
        LogicalDisplay display = new LogicalDisplay(displayId, layerStack, device, mContext);
