...
final class LogicalDisplay {
    ...
    public LogicalDisplay(int displayId, int layerStack, DisplayDevice primaryDisplayDevice, Context context) {
    ...
    public void configureDisplayInTransactionLocked(DisplayDevice device,
        ...
        if (device != mPrimaryDisplayDevice && isFullScreen && displayInfo.logicalWidth > displayInfo.logicalHeight) {
               int miracast_value = Settings.System.getInt(mContext.getContentResolver(), Settings.System.MIRACAST_CONTROL,100);
                   displayRectWidth = physWidth * ((miracast_value)/10 + 90)/100;
                   displayRectHeight = physHeight * ((miracast_value)/10 + 90)/100;
        }
        else if(displayInfo.logicalWidth > displayInfo.logicalHeight)
        {
                   displayRectWidth = physWidth ;
                   displayRectHeight = physHeight;
