...
public class DynamicPManagerService extends IDynamicPManager.Stub {
    ...
    public static String mCurMode = DynamicPManager.BOOST_UPERF_EXTREME;
    ...
    private class BoostUPerfBr extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_BOOT_COMPLETED)) {
                ...
                setCpufreqGovernor(CPU_GOVERNOR_INTERACTIVE);
    ...
    private boolean writeFilex(String path, String data) {
        ...
        try {
            ...
            Log.e(TAG, "Unable to write " + path);
            nRet = false;
        } finally {
            if (fos != null) {
                try {
    ...
    private boolean setCpufreqGovernor(String governor) {
        // cpu0 freq governor
    ...
    private void LowMemoryDevEnterBenMark() {
        ...
        //in benchmark
        if (bMemOpt) {
            LowMemDevKillProTask lpt = new LowMemDevKillProTask(); 
            if (mTimer != null){
                mTimer.schedule(lpt, 10);
            }
