...
public class WallpaperCropActivity extends Activity {
    ...
    private BitmapRegionTileSource.UriBitmapSource bitmapSource = null;
	...
	protected void onDestroy() {
        System.gc();
        bitmapSource.recyclePreviewBitmap();
		super.onDestroy();
	}
            ...
            if (mSetWallpaper && mNoCrop) {
                ...
                if (crop == null) {
                    ...
                    if (fullSize != null) {
						...
						int roundedTrueCrop_width = roundedTrueCrop.width();
						int roundedTrueCrop_height = roundedTrueCrop.height();
						if((roundedTrueCrop_width+roundedTrueCrop.left) > fullSize.getWidth())
							roundedTrueCrop_width = fullSize.getWidth() - roundedTrueCrop.left;
						if((roundedTrueCrop_height+roundedTrueCrop.top) > fullSize.getHeight())
							roundedTrueCrop_height = fullSize.getHeight() - roundedTrueCrop.top;
                        //crop = Bitmap.createBitmap(fullSize, roundedTrueCrop.left,
                        //        roundedTrueCrop.top, roundedTrueCrop_width,
                        //        roundedTrueCrop_height);
                        crop = Bitmap.createBitmap(fullSize, roundedTrueCrop.left,
                                roundedTrueCrop.top, roundedTrueCrop_width,
                                roundedTrueCrop_height);
                    }
