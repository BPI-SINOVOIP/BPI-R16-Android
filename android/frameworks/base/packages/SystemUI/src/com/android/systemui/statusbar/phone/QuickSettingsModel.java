...
class QuickSettingsModel implements BluetoothStateChangeCallback,
    ...
    void refreshScreenShotTile() {
        Resources r = mContext.getResources();
        mScreenShotState.label = r.getString(R.string.quick_settings_screen_shot_label);
    ...
    void refreshScreenRecordTile() {
        Resources r = mContext.getResources();
        mScreenRecordState.label = r.getString(R.string.quick_settings_screen_record_label);
