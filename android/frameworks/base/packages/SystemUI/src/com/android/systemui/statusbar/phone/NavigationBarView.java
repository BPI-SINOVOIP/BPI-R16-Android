...
public class NavigationBarView extends LinearLayout {
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
        ...
        final boolean disableVolumeup = ((disabledFlags & View.STATUS_BAR_DISABLE_HOME)  != 0);
        final boolean disableVolumedown = ((disabledFlags & View.STATUS_BAR_DISABLE_HOME) != 0);
        ...
        // add volume key, 2013-4-25 13:43:23, keep visibility same with HOME button
        if (getResources().getBoolean(R.bool.status_bar_show_volume_button)) {
            View volumeUpButton = getVolumeUpButton();
            View volumeDownButton = getVolumeDownButton();
            if (volumeUpButton != null)
                volumeUpButton.setVisibility(disableVolumeup ? View.INVISIBLE : View.VISIBLE);
            
            if (volumeDownButton != null)
                volumeDownButton.setVisibility(disableVolumedown ? View.INVISIBLE : View.VISIBLE);
        } else {
            View volumeUpButton = getVolumeUpButton();
            View volumeDownButton = getVolumeDownButton();
            if (volumeUpButton != null)
