...
public class AudioManager {
    ...
    */
    ...
    /**
     * Request use of Bluetooth A2DP input for receving audio.
     * <p>
     *
     * @hide
     * @param on set <var>true</var> to use bluetooth A2DP as input device;
     *               <var>false</var> to not use bluetooth A2DP as input device
     */
    public void setBluetoothA2dpInputOn(boolean on){
        IAudioService service = getService();
        try {
            service.setBluetoothA2dpInputOn(on);
        } catch (RemoteException e) {
    ...
    /**
     * Checks whether A2DP input routing is enabled
     *
     * @hide
     * @return true if A2DP input routing is enabled;
     *         false if otherwise
     */
    public boolean isBluetoothA2dpInputOn() {
        IAudioService service = getService();
        try {
            return service.isBluetoothA2dpInputOn();
        } catch (RemoteException e) {
            Log.e(TAG, "Dead object in isBluetoothScoOn", e);
            return false;
        }
    ...
    /**
     * Returns the current players' PlayBackState's list.
     *
     * @hide
     */
    public List<String> getPlayerPlayBackState() {
        ...
        try {
            ...
            mPlayerPlayBackStateList = service.getPlayerPlayBackState();
    ...
    /**
     * Returns the current player Package list.
     *
     * @hide
     */
    public List<String> getPlayerList() {
        ...
        try {
            ...
            mPlayerList = service.getPlayerList();
            return mPlayerList;
        } catch (RemoteException e) {
