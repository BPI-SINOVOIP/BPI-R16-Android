...
public class Movie {
    ...
    private static Movie nativeDecodeStream(InputStream is) {
        ...
        return nativeDecodeMarkedStream(is);
    }
    
    private static native Movie nativeDecodeMarkedStream(InputStream is);
