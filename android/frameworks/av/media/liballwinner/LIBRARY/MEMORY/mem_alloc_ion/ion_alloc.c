...
#if (CONFIG_CHIP != OPTION_CHIP_1639 && CONFIG_CHIP != OPTION_CHIP_1625 && CONFIG_CHIP != OPTION_CHIP_1673 && CONFIG_CHIP != OPTION_CHIP_1689 && CONFIG_CHIP != OPTION_CHIP_1701)
...
#if (CONFIG_CHIP != OPTION_CHIP_1625 && CONFIG_CHIP != OPTION_CHIP_1639 && CONFIG_CHIP != OPTION_CHIP_1673 && CONFIG_CHIP != OPTION_CHIP_1689 && CONFIG_CHIP != OPTION_CHIP_1701)
...
#if ((CONFIG_PRODUCT == OPTION_PRODUCT_PAD && CONFIG_CHIP == OPTION_CHIP_1639) || CONFIG_CHIP == OPTION_CHIP_1625 || CONFIG_CHIP == OPTION_CHIP_1689  || CONFIG_CHIP == OPTION_CHIP_1701)
	alloc_data.heap_id_mask = ION_HEAP_DMA_MASK;
#else
	alloc_data.heap_id_mask = ION_HEAP_CARVEOUT_MASK;
#endif

	//	alloc_data.heap_id_mask = ION_HEAP_DMA_MASK; //C700
	alloc_data.heap_id_mask = ION_HEAP_CARVEOUT_MASK;  //R8
