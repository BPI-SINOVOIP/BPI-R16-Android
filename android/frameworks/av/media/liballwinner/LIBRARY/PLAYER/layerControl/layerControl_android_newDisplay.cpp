...
static int NUM_OF_PICTURES_KEEP_IN_LIST = 2;
...
int LayerDequeueBuffer(LayerCtrl* l,VideoPicture** ppVideoPicture, int bInitFlag)
{
...
int LayerQueueBuffer(LayerCtrl* l,VideoPicture* pInPicture, int bValid)
{
