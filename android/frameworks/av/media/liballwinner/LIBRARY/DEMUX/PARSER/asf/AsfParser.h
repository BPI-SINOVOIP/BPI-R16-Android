...
struct AsfMainHeaderS /*ASFMainHeader*/
{
    ...
    *   if nonzero - subtract from time */
    uint32_t ignore;            /**< preroll is 64bit -
...
struct AsfContextS /*ASFContext*/
{
    ...
    uint64_t data_object_offset;         ///< data object offset (excl. AsfGuid & size)
...
int AsfPsrCoreIoctrl(AsfContextT *p, uint32_t uCmd, uint32_t uParam);
