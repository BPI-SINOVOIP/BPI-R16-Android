...
#define NAVIGATION_PACK_START_CODE  ((unsigned int)0x000001bf)
...
#define LPCM_ID                     0xa0
#define SUB_ID                      0x20
#define PCI_ID                      0x03d4
#define DSI_ID                      0x03fa
...
#define STREAM_TYPE_VIDEO_CODEC_FORMAT_H264      0x1b

#define STREAM_TYPE_CDX_AUDIO_AC3       0x81
#define STREAM_TYPE_AUDIO_CODEC_FORMAT_DTS       0x8a
