...
#ifndef INT64_MAX
#define INT64_MAX 9223372036854775807 /*INT64_C(9223372036854775807)*/
#endif

#ifndef UINT64_MAX
#define UINT64_MAX 0xFFFFFFFFFFFFFFFF /*UINT64_C(0xFFFFFFFFFFFFFFFF)*/
#endif
...
#define MAX_TRACK_SIZE (FFMAX(sizeof(MatroskaVideoTrack), sizeof(MatroskaAudioTrack)))
