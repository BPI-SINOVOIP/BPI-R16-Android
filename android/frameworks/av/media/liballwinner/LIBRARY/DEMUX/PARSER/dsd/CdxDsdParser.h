...
typedef struct {
  ...
  cdx_uint32  channel_num;         // init 0 0 dsd_open, update @ dsf_init or dsdiff:parse_prop_chunk, check not 0
  cdx_uint32  sampling_frequency;  // init 0 0 dsd_open, update @ dsf_init or dsdiff:parse_prop_chunk, check not 0
