...
static void initbits (MP4_STREAM * _ld, cdx_uint8 *stream, cdx_int32 length,cdx_uint8 *bufstartptr,cdx_uint8 *bufendptr)
{
	cdx_int32 i;
	MP4_STREAM * ld = _ld;
...
int h263GetPicHdr(cdx_uint8 *start_addr, cdx_int32 length, cdx_int32 *width, cdx_int32 *height)
{
    ...
    tmp = getbits (ld, 5); /* 1, 0, split_screen_indicator, document_camera_indicator,  freeze_picture_release*/
