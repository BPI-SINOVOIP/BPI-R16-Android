...
{   
    ...
    else if((cur_id & 0xe0) == AUDIO_ID)
	{
		if(cur_id != mMpgParserCxt->nAudioId)
			return NULL;
	}
	else if(mMpgParserCxt->nAudioId==PRIVATE_STREAM_1 && cur_id==mMpgParserCxt->nAudioId)
	{
		code = *cur_packet_ptr;
...
{   
    ...
    {     
          ...
          if(dvdInfo->titleIfoFlag == 1)
            {   
                ...
                {   
                    flag1 = (cur_id!=PRIVATE_STREAM_1)&&(cur_id==dvdInfo->audioIfo.audioPackId[i]);
                    flag2 = (cur_id==PRIVATE_STREAM_1)&&(code==dvdInfo->audioIfo.audioStreamId[i]);
                    if((flag1==1) ||(flag2==1))
                    {   
            ...
            {   
                ...
                for(i=0; i<MpgParser->nhasAudioNum; i++)
                {   
                    flag1 = (cur_id!=PRIVATE_STREAM_1)&&(cur_id==mMpgParserCxt->nAudioIdArray[i]);
                    flag2 = (cur_id==PRIVATE_STREAM_1)&&(code==mMpgParserCxt->bAudioStreamIdCode[i]);
                    if((flag1==1) ||(flag2==1))
                    {   
                        mMpgParserCxt->nSendAudioIndex = i;
                        break;
    ...
    {   
        code = *cur_packet_ptr;
        flag1 = (cur_id==PRIVATE_STREAM_1)&&(code != mMpgParserCxt->mDataChunkT.nSubId);
        flag2 = (cur_id!=PRIVATE_STREAM_1)&&(cur_id != mMpgParserCxt->mDataChunkT.nId);
...
{   
 ...
 {   
	 ...
	 flag3 = (((code & 0xe0) != AUDIO_ID) && (mMpgParserCxt->nAudioId != 0x1bd));
