...
struct _mediaStream
{
	//CdxStreamT* 				httpCoreStreamInfo;	//the streaminfo of httpCore, used for download media segemnt
	CdxDataSourceT*			datasource;        	// the parameter of HttpCoreOpen when download every media segment
