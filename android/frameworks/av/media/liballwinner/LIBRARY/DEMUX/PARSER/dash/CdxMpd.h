...
struct _awSegmentTemplate
{
	...
	char*			index;
	char*			initialization;
	char*			bitstreamSwitch; // not equal to the  bitstreamSwitching in  AW_MPD_MULTIPLE_SEGMENT_BASE
};
...
struct _awPeriod
{
	...
	unsigned int 			duration;   //duration of the Period to determine the start time of next Period
