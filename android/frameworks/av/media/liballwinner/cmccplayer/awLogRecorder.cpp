...
void AwLogRecorderDestroy(AwLogRecorder* l)
{
    ...
    //* send a quit message.
    setMessage(&msg, LOGRECORDER_MSG_QUIT, (unsigned int)&lc->semQuit);
...
int AwLogRecorderRecord(AwLogRecorder* l, char* cmccLog)
{
    ...
    setMessage(&msg, 
               ...
               (unsigned int)&lc->semQuit,      //* params[0] = &semQuit.
               (unsigned int)&lc->nNewLogReply, //* params[1] = &nNewLogReply.
               (unsigned int)cmccLog);          //* params[2] = cmcc log string.
