...
public:
    ...
    virtual audio_io_handle_t openInputRouter(audio_devices_t device,
                                                    audio_io_handle_t output);
...
private:
    ...
    AudioHwDevice*          findSuitableHwDev_byName(const char* module_name,
                                                audio_devices_t devices);
...
#include "Effects.h"
    ...
    private:
        ...
        void                stop_nonvirtual();
              ...
              RoutingThread *checkRoutingThread_l(audio_io_handle_t input) const;
    ...
    mutable     hardware_call_state                 mHardwareStatus;    // for dump only
                ...
                RoutingThread                      *mRoutingThread;
                bool                               mRoutingThreadSuspended;
