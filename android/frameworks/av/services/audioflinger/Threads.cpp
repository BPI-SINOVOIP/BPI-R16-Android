...
status_t AudioFlinger::PlaybackThread::addTrack_l(const sp<Track>& track)
{
    ...
    ALOGV("PlaybackThread::addTrack_l track: %d index: %ld",
          track->name(), mActiveTracks.indexOf(track));
...
{
    ALOGV ("PlaybackThread  ::invalidateTracks() mixer %p, streamType %d, mTracks.size %d",
