...
LOCAL_SRC_FILES := bplus.default.so
LOCAL_MODULE := bplus.default
...
#LOCAL_REQUIRED_MODULES := bt_stack.conf bt_did.conf auto_pair_devlist.conf iop_bt.db
LOCAL_REQUIRED_MODULES := bt_stack.conf bt_did.conf auto_pair_devlist.conf
