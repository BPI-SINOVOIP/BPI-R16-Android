...
public class Storage {
    ...
    public static ContentValues getContentValuesForData(String title,
    	...
    	// mtp:File transfers from device to host will likely fail if the size is incorrect.
        // So to be safe, use the actual file size here.
    	//modified by lingchao,allwinner kp206
    	long actualLength=new File(path).length();
        ...
        values.put(ImageColumns.SIZE, actualLength/*jpegLength*/);
