...
public class WideAnglePanoramaModule
    ...
    private String mExifMake = "MAKE_A33";
    private String mExifModel = "MODEL_A33";
    ...
    private Uri savePanorama(byte[] jpegData, int width, int height, int orientation) {
		...
		exif.setTag(exif.buildTag(ExifInterface.TAG_MAKE,mExifMake));
  		exif.setTag(exif.buildTag(ExifInterface.TAG_MODEL,mExifModel));
