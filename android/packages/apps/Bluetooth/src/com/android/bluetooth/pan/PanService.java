...
public class PanService extends ProfileService {
    ...
    private AsyncChannel mTetherAc;
    ...
    protected boolean stop() {
        /*if (mTetherAc != null) {
            mTetherAc.disconnect();   //Allow AsyncChannel receiver to disconnect
            mTetherAc = null;
        }*/
        return true;
    }
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                {
                    if (DBG) log("CMD_CHANNEL_DISCONNECTED");
                    if (mTetherAc != null) {
                        //prevent race condition in AsycChannel, always cleared by other side
                        //mTetherAc.disconnected();
                        mTetherAc = null;
                    }
                }
                break;
