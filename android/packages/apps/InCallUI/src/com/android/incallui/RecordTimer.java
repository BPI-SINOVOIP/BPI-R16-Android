 ...
 */
public class RecordTimer extends Handler {
    ...
    public RecordTimer(Runnable callback) {
        ...
        mRunning = false;
        mCallback = callback;
        mInternalCallback = new RecordTimerCallback();
    }
    ...
    private class RecordTimerCallback implements Runnable {
        @Override
        public void run() {
            periodicUpdateTimer();
        }
