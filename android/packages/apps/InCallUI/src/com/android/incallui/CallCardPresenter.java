...
public class CallCardPresenter extends Presenter<CallCardPresenter.CallCardUi>
    ...
    private long mCallToRecordStartDuration;
    ...
    public CallCardPresenter() {
        ...
        mRecordTimer = new RecordTimer(new Runnable() {
            @Override
            public void run() {
                updateRecordTime();
            }
    ...
    public void onStateChange(InCallState state, CallList callList) {
	    ...
	    mRecordTimer.cancel();
            ui.setPrimaryCallRecordTime(false, null);
        }
    ...
    public void setCallToRecordStartDuration()
    {
	mCallToRecordStartDuration=System.currentTimeMillis() - mPrimary.getConnectTime();;
        //Log.d(this, "record mCallToRecordStartDuration=" + mCallToRecordStartDuration);
    }
    ...
    public void updateRecordTime() {
        ...
        if (ui == null || mPrimary == null || mPrimary.getState() != Call.State.ACTIVE) {
            ...
            final long callStart = mPrimary.getConnectTime();
            final long duration = System.currentTimeMillis() - callStart - mCallToRecordStartDuration;
            ui.setPrimaryCallRecordTime(true, DateUtils.formatElapsedTime(duration / 1000));
        }
    }

    public void startRecordTimer() {
	mRecordTimer.start(CALL_TIME_UPDATE_INTERVAL);	
        return;
    }
    ...
    public interface CallCardUi extends Ui {
        ...
        void setPrimaryCallRecordTime(boolean show, String duration);
