...
public class CallCardFragment extends BaseFragment<CallCardPresenter, CallCardPresenter.CallCardUi>
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mRecordTime = (TextView) view.findViewById(R.id.recordTime);
    ...
    @Override
    public void setPrimaryCallRecordTime(boolean show, String callTimeElapsed) {
        if (show) {
            if (mRecordTime.getVisibility() != View.VISIBLE) {
                AnimationUtils.Fade.show(mRecordTime);
            }
            mRecordTime.setText(callTimeElapsed);
        } else {
            // hide() animation has no effect if it is already hidden.
            AnimationUtils.Fade.hide(mRecordTime, View.INVISIBLE);
        }
    }
    ...
    {
	getPresenter().setCallToRecordStartDuration();
        //Log.d(this, "setCallToRecordStartDuration record " );
    }

    public void startRecordTimer() {
	getPresenter().startRecordTimer();
        return;
    }

    public void stopRecordTimer() {
	getPresenter().stopRecordTimer();
        return;
    }
