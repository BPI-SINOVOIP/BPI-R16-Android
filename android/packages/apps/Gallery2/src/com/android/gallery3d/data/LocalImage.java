...
import com.android.gallery3d.gif.GifRequest;
...
public class LocalImage extends LocalMediaItem {
    ...
    public Job<GifData> requestGifImage(){
        return new GifDataJob(filePath);
    }
    ...
    private class GifDataJob implements Job<GifData> {
        private String mLocalFilePath;
        public GifDataJob(String localFilePath) {
            mLocalFilePath = localFilePath;
        }

        @Override
        public GifData run(JobContext jc) {            
            Log.i(TAG, "mLocalFilePath=" + mLocalFilePath);
            GifData gifData = GifRequest.request(jc, mLocalFilePath);
            
            Log.i(TAG, "gifData=" + gifData);
            if (jc.isCancelled() || gifData == null) {
                return null;
            }
