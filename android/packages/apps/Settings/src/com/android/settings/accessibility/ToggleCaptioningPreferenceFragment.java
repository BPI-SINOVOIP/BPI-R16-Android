...
public class ToggleCaptioningPreferenceFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        if(com.android.settings.Settings.mIsSettingOn == false) {
            rootView = inflater.inflate(R.layout.captioning_preview, container, false);
            com.android.settings.Settings.mIsSettingOn = true;
        }
    ...
    private void installActionBarToggleSwitch() {
        final Activity activity = getActivity();
        mToggleSwitch = new ToggleSwitch(activity);
        ...
        actionBar.setCustomView(mToggleSwitch, params);
        ...
        mToggleSwitch.setOnBeforeCheckedChangeListener(new OnBeforeCheckedChangeListener() {
            @Override
            public boolean onBeforeCheckedChanged(ToggleSwitch mToggleSwitch, boolean checked) {
