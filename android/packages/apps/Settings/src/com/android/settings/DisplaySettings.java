...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_MIRACAST_FULL_SCREEN = "miracast_full_screen";
    private static final String KEY_ACCELEROMETER_COORDINATE = "accelerometer_coornadite";
    private static final String KEY_MIRACAST_CONTROL_SCREEN = "miracast_control";
    ...
    private CheckBoxPreference mMiracastFullScreen;
    private MiracastControlPreference mMiracastControlPreference;
	...
	mAccelerometerCoordinate = (ListPreference) findPreference(KEY_ACCELEROMETER_COORDINATE);
        ...
        mMiracastFullScreen = (CheckBoxPreference)findPreference(KEY_MIRACAST_FULL_SCREEN);
        mMiracastControlPreference = (MiracastControlPreference)findPreference(KEY_MIRACAST_CONTROL_SCREEN);
        if (mWifiDisplayStatus.getFeatureState()
                == WifiDisplayStatus.FEATURE_STATE_UNAVAILABLE) {
            getPreferenceScreen().removePreference(mWifiDisplayPreference);
            mWifiDisplayPreference = null;
            getPreferenceScreen().removePreference(mMiracastFullScreen);
            mMiracastFullScreen = null;
            getPreferenceScreen().removePreference(mMiracastControlPreference);
            mMiracastControlPreference = null;
        }
        else
        {
            //miracast output mode
            final boolean isMiracastFullScreen = Settings.System.getInt(resolver,
                                                                        Settings.System.MIRACAST_FULL_SCREEN, 0) > 0;
            mMiracastFullScreen.setChecked(isMiracastFullScreen);
	...
	*/
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
		...
		if(value == false)
		{
			value2 = Settings.System.getInt(getContentResolver(),
				Settings.System.BRIGHTNESS_LIGHT_MODE);
			Settings.System.putInt(getContentResolver(),Settings.System.BRIGHTNESS_LIGHT_MODE,value2&0x01);
		}
                ...
                Settings.System.putInt(getContentResolver(),Settings.System.BRIGHTNESS_LIGHT_MODE,
                        value ? value2|0x02 : value2&0x01);
            } else if (preference == mMiracastFullScreen) {
		value = mMiracastFullScreen.isChecked();
		Settings.System.putInt(getContentResolver(),Settings.System.MIRACAST_FULL_SCREEN,
		         value ? 0x01 : 0);
	    }
