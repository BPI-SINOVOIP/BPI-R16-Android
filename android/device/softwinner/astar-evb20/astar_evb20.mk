...
# init.rc, kernel
PRODUCT_COPY_FILES += \
	device/softwinner/astar-evb20/kernel:kernel \
	device/softwinner/astar-evb20/modules/modules/nand.ko:root/nand.ko \
	device/softwinner/astar-evb20/init.sun8i.rc:root/init.sun8i.rc \
	device/softwinner/astar-evb20/ueventd.sun8i.rc:root/ueventd.sun8i.rc \
	device/softwinner/astar-evb20/initlogo.rle:root/initlogo.rle  \
	device/softwinner/astar-evb20/media/bootanimation.zip:system/media/bootanimation.zip \
	device/softwinner/astar-evb20/media/boot.wav:system/media/boot.wav \
	device/softwinner/astar-evb20/media/initlogo.bmp:system/media/initlogo.bmp \
	device/softwinner/astar-evb20/fstab.sun8i:root/fstab.sun8i \
	device/softwinner/astar-evb20/init.recovery.sun8i.rc:root/init.recovery.sun8i.rc
...
PRODUCT_COPY_FILES += \
	device/softwinner/astar-evb20/configs/sunxi-keyboard.kl:system/usr/keylayout/sunxi-keyboard.kl \
	device/softwinner/astar-evb20/configs/tp.idc:system/usr/idc/tp.idc \
	device/softwinner/astar-evb20/configs/gsensor.cfg:system/usr/gsensor.cfg

#copy touch and keyboard driver to recovery randisk
PRODUCT_COPY_FILES += \
    device/softwinner/astar-evb20/modules/modules/disp.ko:obj/disp.ko \
    device/softwinner/astar-evb20/modules/modules/sunxi-keyboard.ko:obj/sunxi-keyboard.ko \
    device/softwinner/astar-evb20/modules/modules/lcd.ko:obj/lcd.ko \
    device/softwinner/astar-evb20/modules/modules/gt82x.ko:obj/gt82x.ko \
    device/softwinner/astar-evb20/modules/modules/gt818_ts.ko:obj/gt818_ts.ko \
    device/softwinner/astar-evb20/modules/modules/sw-device.ko:obj/sw-device.ko
...
#vold config
PRODUCT_COPY_FILES += \
	device/softwinner/astar-evb20/recovery.fstab:recovery.fstab 
# camera
PRODUCT_COPY_FILES += \
	device/softwinner/astar-evb20/configs/camera.cfg:system/etc/camera.cfg \
	device/softwinner/astar-evb20/configs/media_profiles.xml:system/etc/media_profiles.xml \
...
# evb logger
PRODUCT_COPY_FILES += \
       device/softwinner/astar-evb20/tools/logger.sh:system/bin/logger.sh
...
$(call inherit-product-if-exists, device/softwinner/astar-evb20/modules/modules.mk)

DEVICE_PACKAGE_OVERLAYS := device/softwinner/astar-evb20/overlay
...
PRODUCT_NAME   := astar_evb20
PRODUCT_DEVICE := astar-evb20
