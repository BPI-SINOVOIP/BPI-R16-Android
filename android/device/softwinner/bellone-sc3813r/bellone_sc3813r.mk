...
# init.rc, kernel
PRODUCT_COPY_FILES += \
	device/softwinner/bellone-sc3813r/kernel:kernel \
	device/softwinner/bellone-sc3813r/modules/modules/nand.ko:root/nand.ko \
	device/softwinner/bellone-sc3813r/init.sun8i.rc:root/init.sun8i.rc \
	device/softwinner/bellone-sc3813r/ueventd.sun8i.rc:root/ueventd.sun8i.rc \
	device/softwinner/bellone-sc3813r/initlogo.rle:root/initlogo.rle  \
	device/softwinner/bellone-sc3813r/media/bootanimation.zip:system/media/bootanimation.zip \
	device/softwinner/bellone-sc3813r/media/boot.wav:system/media/boot.wav \
	device/softwinner/bellone-sc3813r/media/bootlogo.bmp:system/media/bootlogo.bmp \
	device/softwinner/bellone-sc3813r/media/initlogo.bmp:system/media/initlogo.bmp \
	device/softwinner/bellone-sc3813r/fstab.sun8i:root/fstab.sun8i \
	device/softwinner/bellone-sc3813r/init.recovery.sun8i.rc:root/init.recovery.sun8i.rc
...
PRODUCT_COPY_FILES += \
	device/softwinner/bellone-sc3813r/configs/sunxi-keyboard.kl:system/usr/keylayout/sunxi-keyboard.kl \
	device/softwinner/bellone-sc3813r/configs/tp.idc:system/usr/idc/tp.idc \
	device/softwinner/bellone-sc3813r/configs/gsensor.cfg:system/usr/gsensor.cfg \
#	device/softwinner/bellone-sc3813r/configs/sunxi-ir.kl:system/usr/keylayout/sunxi-ir.kl


#copy touch and keyboard driver to recovery randisk
PRODUCT_COPY_FILES += \
    device/softwinner/bellone-sc3813r/modules/modules/disp.ko:obj/disp.ko \
    device/softwinner/bellone-sc3813r/modules/modules/sunxi-keyboard.ko:obj/sunxi-keyboard.ko \
    device/softwinner/bellone-sc3813r/modules/modules/lcd.ko:obj/lcd.ko \
    device/softwinner/bellone-sc3813r/modules/modules/gt82x.ko:obj/gt82x.ko \
    device/softwinner/bellone-sc3813r/modules/modules/ft5x_ts.ko:obj/ft5x_ts.ko \
    device/softwinner/bellone-sc3813r/modules/modules/sw-device.ko:obj/sw-device.ko
...
PRODUCT_PACKAGES += easysetupserver
...
#vold config
PRODUCT_COPY_FILES += \
	device/softwinner/bellone-sc3813r/recovery.fstab:recovery.fstab 
# camera
PRODUCT_COPY_FILES += \
	device/softwinner/bellone-sc3813r/configs/camera.cfg:system/etc/camera.cfg \
	device/softwinner/bellone-sc3813r/configs/media_profiles.xml:system/etc/media_profiles.xml \
...
# evb logger
PRODUCT_COPY_FILES += \
       device/softwinner/bellone-sc3813r/tools/logger.sh:system/bin/logger.sh
...
$(call inherit-product-if-exists, device/softwinner/bellone-sc3813r/modules/modules.mk)

DEVICE_PACKAGE_OVERLAYS := device/softwinner/bellone-sc3813r/overlay
PRODUCT_CHARACTERISTICS := tablet

# Overrides
PRODUCT_AAPT_CONFIG := xlarge hdpi xhdpi large mdpi
PRODUCT_AAPT_PREF_CONFIG := xhdpi

PRODUCT_BRAND  := Allwinner-Tablet
PRODUCT_NAME   := bellone_sc3813r
PRODUCT_DEVICE := bellone-sc3813r
