...
# init.rc, kernel
PRODUCT_COPY_FILES += \
	device/softwinner/astar-evb/kernel:kernel \
	device/softwinner/astar-evb/modules/modules/nand.ko:root/nand.ko \
	device/softwinner/astar-evb/init.sun8i.rc:root/init.sun8i.rc \
	device/softwinner/astar-evb/ueventd.sun8i.rc:root/ueventd.sun8i.rc \
	device/softwinner/astar-evb/initlogo.rle:root/initlogo.rle  \
	device/softwinner/astar-evb/media/bootanimation.zip:system/media/bootanimation.zip \
	device/softwinner/astar-evb/media/boot.wav:system/media/boot.wav \
	device/softwinner/astar-evb/media/initlogo.bmp:system/media/initlogo.bmp \
	device/softwinner/astar-evb/fstab.sun8i:root/fstab.sun8i \
	device/softwinner/astar-evb/init.recovery.sun8i.rc:root/init.recovery.sun8i.rc
...
PRODUCT_COPY_FILES += \
    device/softwinner/astar-evb/modules/modules/disp.ko:obj/disp.ko \
    device/softwinner/astar-evb/modules/modules/sunxi-keyboard.ko:obj/sunxi-keyboard.ko \
    device/softwinner/astar-evb/modules/modules/lcd.ko:obj/lcd.ko \
    device/softwinner/astar-evb/modules/modules/gt82x.ko:obj/gt82x.ko \
    device/softwinner/astar-evb/modules/modules/gt818_ts.ko:obj/gt818_ts.ko \
    device/softwinner/astar-evb/modules/modules/sw-device.ko:obj/sw-device.ko
...
#vold config
PRODUCT_COPY_FILES += \
	device/softwinner/astar-evb/recovery.fstab:recovery.fstab 
# camera
PRODUCT_COPY_FILES += \
	device/softwinner/astar-evb/configs/camera.cfg:system/etc/camera.cfg \
	device/softwinner/astar-evb/configs/media_profiles.xml:system/etc/media_profiles.xml \
...
# evb logger
PRODUCT_COPY_FILES += \
       device/softwinner/astar-evb/tools/logger.sh:system/bin/logger.sh
...
$(call inherit-product-if-exists, device/softwinner/astar-evb/modules/modules.mk)

DEVICE_PACKAGE_OVERLAYS := device/softwinner/astar-evb/overlay
