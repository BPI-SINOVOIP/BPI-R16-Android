...
// set defaut value before
	mExposureTime.num = 2;
	mExposureTime.den = 1000;
	mFNumber.num = 200;	//eg:FNum=2.2, aperture = 220, --> num = 220,den = 100
	mFNumber.den = 100;
	mISOSpeed = 50;
	mExposureBiasValue.num = -4;
	mExposureBiasValue.den = 1;
	mMeteringMode = 1;
	mFlashUsed = 0;
	mFocalLength_r.num = 1400;
	mFocalLength_r.den = 100;
	mDigitalZoomRatio.num = 100;
	mDigitalZoomRatio.den = 100;
	mExposureMode = 1;
// set defaut value end
