...
class Device {
  public:
    ...
    enum BuiltinAction { NO_ACTION, REBOOT, APPLY_EXT, APPLY_CACHE,
                         APPLY_ADB_SIDELOAD, WIPE_DATA, WIPE_CACHE, APPLY_INT };
    ...
    virtual const char* GetIntStoragePath() = 0;
    // Retrun internal storage patch 
    virtual const char* GetExtStoragePath() = 0;
};
