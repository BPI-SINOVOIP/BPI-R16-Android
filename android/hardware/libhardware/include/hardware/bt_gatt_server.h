...
typedef struct {
    ...
    /** Start broadcasting advertisement packages */
    bt_status_t (*start_broadcast)(uint16_t min_interval, uint16_t max_interval,
                                   uint16_t appearance, uint8_t flags,
                                   uint16_t manufacturer_len, char* manufacturer_data);
    /** Stop broadcasting advertisement packages */
    bt_status_t (*stop_broadcast)();
