...
/** Callback for SDP result of remote HDP device.
 *  datatype will represent the types of device supported as source role
 */
typedef void (* bthl_remote_source_datatype_callback)(int app_id, bt_bdaddr_t *bd_addr, int* source_datatypes, int size);
/** Callback for SDP result of remote HDP device.
 *  datatype will represent the types of device supported as sink role
 */
typedef void (* bthl_remote_sink_datatype_callback)(int app_id, bt_bdaddr_t *bd_addr, int* sink_datatypes, int size);
...
typedef struct {
    ...
    bthl_remote_source_datatype_callback        source_datatype_cb;
    bthl_remote_sink_datatype_callback             sink_datatype_cb;
} bthl_callbacks_t;
...
typedef struct {
    ...
    /** get device datatype through SDP*/
    bt_status_t (*get_device_datatype)(int app_id, bt_bdaddr_t *bd_addr);
