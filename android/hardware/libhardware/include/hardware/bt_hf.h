...
/** Callback for BRSF. It pass remote feature and local featue.
 */
typedef void (* bthf_brsf_callback)(int local_feature, int peer_feature, bt_bdaddr_t *bd_addr);
