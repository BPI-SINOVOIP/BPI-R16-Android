...
#define BT_HARDWARE_MODULE_ID "bplus"
#define BT_STACK_MODULE_ID "bplus"
#define BT_STACK_TEST_MODULE_ID "bplus_test"


/* Bluetooth profile interface IDs */

#define BT_PROFILE_HANDSFREE_ID "handsfree"
#define BT_PROFILE_HF_DEVICE_ID "hfdevice"
...
#define BT_PROFILE_MAPMSE_ID "mapmse"
#define BT_PROFILE_GATT_ID "gatt"
#define BT_PROFILE_FTP_ID "ftp"
#define BT_PROFILE_SAP_ID "sap"
#define BT_PROFILE_AV_RC_ID "avrcp"
#define BT_PROFILE_DUN_ID "dun"
#define BT_PROFILE_HIDDEVICE_ID "hiddevice"
#define BT_PROFILE_AV_RCC_ID "avrcp-ct"
#define BT_PROFILE_OPP_ID "opp"
#define BT_PROFILE_MAPMCE_ID "mapmce"
...
typedef enum {
    ...
    BT_CTP_SERVICE_ID,              /* Cordless Terminal */
...
typedef struct {
   ...
   int (*authorize_response)(const bt_bdaddr_t *bd_addr, bt_service_id_t service_id,
    ...
    int (*init_wake_lock)(int lock_fd, int unlock_fd);
    /** BLE Test Mode APIs */
    /* opcode MUST be one of: LE_Receiver_Test, LE_Transmitter_Test, LE_Test_End */
    int (*le_test_mode)(uint16_t opcode, uint8_t *buf, uint8_t len);

    int (*ssp_debug_configure)(uint8_t enable);
    /* enable or disable bluetooth HCI snoop log */
    int (*config_hci_snoop_log)(uint8_t enable);
    int (*update_radio_count_native)(bt_radio_type_t radio_type, uint8_t count);
