...
**
*******************************************************************************/
void BTA_MaBmsgSetFolder(tBTA_MA_BMSG * p_msg, const char * p_folder)
{
    if ( p_msg && p_folder )
    {
        ...
        if ( p_msg->p_folder )
            strcpy(p_msg->p_folder, p_folder);
    }
}
...
**
*******************************************************************************/
void BTA_MaBmsgAddMsgContent(tBTA_MA_BMSG_CONTENT * p_content, const char * p_text)
{
    ...
    if ( p_content )
    {
        ...
        if ( p_message )
        {
            ...
            if ( p_message->p_text )
            {
                strcpy(p_message->p_text, p_text);
...
**
*******************************************************************************/
tBTA_MA_VCARD_PROPERTY * BTA_MaBmsgAddVcardProp(tBTA_MA_BMSG_VCARD * p_vcard, tBTA_MA_VCARD_PROP prop,const char * p_value, const char * p_param)
{
