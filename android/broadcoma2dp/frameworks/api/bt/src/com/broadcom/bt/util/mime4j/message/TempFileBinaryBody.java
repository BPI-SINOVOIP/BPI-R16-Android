...
import com.broadcom.bt.util.mime4j.util.TempPath;
import com.broadcom.bt.util.mime4j.util.TempStorage;


/**
 * Binary body backed by a {@link com.broadcom.bt.util.mime4j.util.TempFile}.
 *
 *
...
class TempFileBinaryBody extends AbstractBody implements BinaryBody {
    ...
    /**
     * @see com.broadcom.bt.util.mime4j.message.AbstractBody#getParent()
     */
    ...
    /**
     * @see com.broadcom.bt.util.mime4j.message.AbstractBody#setParent(org.apache.james.mime4j.message.Entity)
     */
    ...
    /**
     * @see com.broadcom.bt.util.mime4j.message.BinaryBody#getInputStream()
     */
    ...
    /**
     * @see com.broadcom.bt.util.mime4j.message.Body#writeTo(java.io.OutputStream)
     */
