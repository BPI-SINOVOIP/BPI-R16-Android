...
#define BOOT_EMERG	    "<0>"	/* system is unusable			*/
#define BOOT_ALERT	    "<1>"	/* action must be taken immediately	*/
#define BOOT_CRIT	    "<2>"	/* critical conditions			*/
#define BOOT_ERR	    "<3>"	/* error conditions			*/
#define BOOT_WARNING    "<4>"	/* warning conditions			*/
#define BOOT_NOTICE	    "<5>"	/* normal but significant condition	*/
#define BOOT_INFO	    "<6>"	/* informational			*/
#define BOOT_DEBUG	    "<7>"	/* debug-level messages			*/
