...
int sunxi_card_sprite_main(int workmode, char *name)
{
	...
	if(production_media != 3)
	{
		...
		printf("firmware probe ok\n");
		//获取dl_map文件，用于指引下载的数据
		printf("fetch download map\n");
		...
		printf("successed in erasing flash\n");
		...
		printf("successed in downloading part\n");
		...
		printf("successed in downloading uboot\n");
		...
		printf("successed in downloading boot0\n");
