...
int axp_set_hardware_poweron_vol(void) //设置开机之后，PMU硬件关机电压为2.9V
{
	...
	{
		printf("set power on vol to default\n");
	}
...
int axp_set_hardware_poweroff_vol(void) //设置关机之后，PMU硬件下次开机电压为3.3V
{
	...
	{
		printf("set power off vol to default\n");
	}
